...
<p align="center">
  ...
  <img src="https://raw.githubusercontent.com/SamsungSAILMontreal/ByteCraft/resource/screenshots.png" alt="Screenshots of files generated by ByteCraft"  style="width: 100%;">
</p>

You can find xamples of generated files in our [blog-post](https://emygervais.github.io/2025/03/15/bytecraft.html). We also provide a [Paper/Tech-report](https://raw.githubusercontent.com/SamsungSAILMontreal/ByteCraft/paper/ByteCraft.pdf).
...
Through vLLM, you can generate multiple files at a time (option max_num_seqs, set it to the maximum given to you by vLLM). On a A100 80Gb GPU, you can generate 25 files at a time in about 10min.
...
See exp/generating_video_games.sh for examples on how to use generating SWF files with each of the 3 methods provided.

Note that the model does not work when loaded in float16 (it returns "!!!!!!!!!"); it only works properly in bfloat16. It is not clear why this is the case.
